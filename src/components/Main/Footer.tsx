  ...
  return (
    <footer className="w-full flex-center border-gray86 border-t">
      <div className="max-w py-6">
        <div className="flex justify-start sm:flex-col md:flex-row">
          <div className=" sm:pr-4 text-4xl sm:pb-6 whitespace-nowrap font-NanumSquareRoundBold">
            goorm
          </div>
          <div className="sm:flex flex-col text-gray86 overflow-hidden whitespace-nowrap hidden">
          ...
          <div className="px-3 text-slate-500 overflow-hidden whitespace-nowrap sm:hidden">
